"""
screenshot uses setup tools for packaging.

To Build screenshot as a Python package
...
setup(
    name=NAME,
    version="0.0.0",
    description="My screenshot tool",
    ...
    entry_points={
        "console_scripts": ["screenshot = screenshot:main"],
    },
)
